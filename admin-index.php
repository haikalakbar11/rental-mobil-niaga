<?php 
session_start(); require_once "../config.php"; if (!isset($_SESSION["admin"])) { 
...
<head> 
    ...
    <title>ADMIN | NIAGA TRANSPORT</title> 
...
<body> 
    <div class="container"> 
        ...
        <nav class="navbar navbar-dark bg-dark navbar-expand-md" style="border-radius: 5px;"> 
            <div class="container"> 
                <a class="navbar-brand navbar-logo" href="#" style="font-size: 
25px;">ADMIN | NiagaTransport</a> 
                ...
                <div class="collapse navbar-collapse" id="navcol-1"> 
                    <ul class="nav navbar-nav ml-auto"> 
                        <li class="nav-item"><a class="nav-link" href="?page=home"><i class="fas fa-home"></i> Home <span class="sr-only">(current)</span></a></li>                         <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-pencil-alt"></i> Input</a> 
                        ...
                        <li class="nav-item"><a class="nav-link" data-display="static" aria-expanded="false" href="#" style="margin-right: 15px; font-weight: bold; color: 
red;"><?= ucfirst($_SESSION["admin"]["username"]) ?></a> 
                        </li> 
                    </ul> 
                </div> 
            </div> 
